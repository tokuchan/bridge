/// @file gcc.hpp
/// @brief This file holds the GCC compiler version Detector. See
...
/// @brief This is GCC's major version, or `0` when not compiling
///        with real GCC.
///
/// Clang also defines `__GNUC__` and `__GNUC_MINOR__`, for source
/// compatibility. So real-GCC detection excludes `__clang__`
/// explicitly.
...
/// @brief This checks whether GCC's version is greater than `n`.
